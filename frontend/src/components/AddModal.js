...
const AddModal=()=> {
	...
	const handleChange=(event)=>{
  	...
  	const handleSubmit=(e)=>{
  		...
  		axios.post(
	      `http://127.0.0.1:8000/api/products/addProduct`,input,config
	      ).then(
	        (res)=>{
	...
	return (
		<Wrapper>
		<div>
    	<div className="modal fade" id="addProduct" role="dialog" aria-labelledby="addProduct" aria-hidden="true">
        <div className="modal-dialog" role="document">
          <div className="modal-content" style={{"width":"1000px", "margin-left":"-250px"}}>
            <form encType="multipart/form-data" onSubmit={handleSubmit} >
              <div className="modal-header">
                <h5 className="modal-title" id="addProduct">Upload Products</h5>
              ...
              <div className="modal-body">
                <div className="position-relative form-group files">
                  ...
                  <label>Color</label>
                  <input  name="color" type="text" value={input.color} onChange={handleChange} className="form-control" />                  
                  <label>Image Url</label>
                  <input  name="image" type="text" value={input.image} onChange={handleChange} className="form-control" />
